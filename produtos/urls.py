...
from .views import ProdutosListView, ProdutosCreateView, ProdutosUpdateView, ProdutoDetailView, GrupoDetailView, GrupoListView,GrupoProdutosView, filtrar_produtos
...
urlpatterns = [
    ...
    path('grupo/<int:grupo_id>/', GrupoProdutosView.as_view(), name='grupo_produtos'),
